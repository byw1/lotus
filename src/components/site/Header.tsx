    ...
    <header className="border-line bg-bg/80 sticky top-0 z-50 border-b backdrop-blur-xl">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-6 px-6 sm:h-18 sm:px-8">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/get-involved"
            className="bg-rose-solid hover:bg-rose-deep hidden h-10 items-center rounded-full px-5 text-sm font-medium text-white transition-colors duration-200 sm:inline-flex"
          >
            Get involved
          </Link>
